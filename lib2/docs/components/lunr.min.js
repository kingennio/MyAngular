...
lunr.version = "0.4.0", "undefined" != typeof module && (module.exports = lunr), lunr.utils = {}, lunr.utils.warn = function (t) {
    return function (e) {
    ...
    for (var t = t.replace(/^\s+/, ""), e = t.length - 1; e >= 0; e--)if (/\S/.test(t.charAt(e))) {
        t = t.substring(0, e + 1);
        break
    }
    ...
    for (var t, e = 0, n = this.elements, r = n.length, i = 0; r > i; i++)t = n[i], e += t * t;
    return this._magnitude = Math.sqrt(e)
}, lunr.Vector.prototype.dot = function (t) {
    for (var e = this.elements, n = t.elements, r = e.length, i = 0, o = 0; r > o; o++)i += e[o] * n[o];
    return i
    ...
    var e = e || 0, n = n || this.elements.length, r = n - e, i = e + Math.floor(r / 2), o = this.elements[i];
    ...
    var n = {}, r = new lunr.SortedSet, i = t[this._ref], e = void 0 === e ? !0 : e;
    ...
    for (var o = 0; r.length > o; o++) {
        var s = r.elements[o], l = this._fields.reduce(function (t, e) {
        ...
        this.tokenStore.add(s, {ref: i, tf: l})
    }
    ...
    var e = this.pipeline.run(lunr.tokenizer(t)), n = lunr.utils.zeroFillArray(this.corpusTokens.length), r = [], i = this._fields.reduce(function (t, e) {
        return t + e.boost
    }, 0), o = e.some(function (t) {
        return this.tokenStore.has(t)
    }, this);
    if (!o)return[];
    e.forEach(function (t, e, o) {
        var s = 1 / o.length * this._fields.length * i, l = this, u = this.tokenStore.expand(t).reduce(function (e, r) {
            var i = l.corpusTokens.indexOf(r), o = l.idf(r), u = 1, a = new lunr.SortedSet;
            if (r !== t) {
    ...
    for (var e = this.documentStore.get(t), n = e.length, r = lunr.utils.zeroFillArray(this.corpusTokens.length), i = 0; n > i; i++) {
        var o = e.elements[i], s = this.tokenStore.get(o)[t].tf, l = this.idf(o);
    ...
    var t = {ational: "ate", tional: "tion", enci: "ence", anci: "ance", izer: "ize", bli: "ble", alli: "al", entli: "ent", eli: "e", ousli: "ous", ization: "ize", ation: "ate", ator: "ate", alism: "al", iveness: "ive", fulness: "ful", ousness: "ous", aliti: "al", iviti: "ive", biliti: "ble", logi: "log"}, e = {icate: "ic", ative: "", alize: "al", iciti: "ic", ical: "ic", ful: "", ness: ""}, n = "[^aeiou]", r = "[aeiouy]", i = n + "[^aeiouy]*", o = r + "[aeiou]*", s = "^(" + i + ")?" + o + i, l = "^(" + i + ")?" + o + i + "(" + o + ")?$", u = "^(" + i + ")?" + o + i + o + i, a = "^(" + i + ")?" + r;
    return function (n) {
        var o, h, c, p, f, d, v;
        ...
        if (c = n.substr(0, 1), "y" == c && (n = c.toUpperCase() + n.substr(1)), p = /^(.+?)(ss|i)es$/, f = /^(.+?)([^s])s$/, p.test(n) ? n = n.replace(p, "$1$2") : f.test(n) && (n = n.replace(f, "$1$2")), p = /^(.+?)eed$/, f = /^(.+?)(ed|ing)$/, p.test(n)) {
            ...
            var m = f.exec(n);
            o = m[1], f = RegExp(a), f.test(o) && (n = o, f = /(at|bl|iz)$/, d = RegExp("([^aeiouylsz])\\1$"), v = RegExp("^" + i + r + "[^aeiouwxy]$"), f.test(n) ? n += "e" : d.test(n) ? (p = /.$/, n = n.replace(p, "")) : v.test(n) && (n += "e"))
        }
        if (p = /^(.+?)y$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1], p = RegExp(a), p.test(o) && (n = o + "i")
        }
        if (p = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1], h = m[2], p = RegExp(s), p.test(o) && (n = o + t[h])
        }
        if (p = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1], h = m[2], p = RegExp(s), p.test(o) && (n = o + e[h])
        }
        if (p = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, f = /^(.+?)(s|t)(ion)$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1], p = RegExp(u), p.test(o) && (n = o)
        } else if (f.test(n)) {
            var m = f.exec(n);
            o = m[1] + m[2], f = RegExp(u), f.test(o) && (n = o)
        }
        if (p = /^(.+?)e$/, p.test(n)) {
            var m = p.exec(n);
            o = m[1], p = RegExp(u), f = RegExp(l), d = RegExp("^" + i + r + "[^aeiouwxy]$"), (p.test(o) || f.test(o) && !d.test(o)) && (n = o)
        }
    ...
    var n = n || this.root, r = t[0], i = t.slice(1);
    return r in n || (n[r] = {docs: {}}), 0 === i.length ? (n[r].docs[e.ref] = e, this.length += 1, void 0) : this.add(i, e, n[r])
