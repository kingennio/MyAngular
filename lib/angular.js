 ...
 *     });
     ...
     * @example
     ...
     <doc:scenario>
     it('should format myNumbers', function() {
     ...
     * @example
     ...
     <script>
     function Ctrl($scope) {
           $scope.myNumbers = [1,2,3,4,5,6,7,8,9];
           $scope.limit = 3;
         }
     </script>
     <div ng-controller="Ctrl">
     Limit {{myNumbers}} to: <input type="integer" ng-model="limit">
     <p>Output: {{ myNumbers | limitTo:limit }}</p>
     </div>
     </doc:source>
     <doc:scenario>
     it('should limit the numer array to first three items', function() {
         expect(element('.doc-example-live input[ng-model=limit]').val()).toBe('3');
         expect(binding('myNumbers | limitTo:limit')).toEqual('[1,2,3]');
       });

     it('should update the output when -3 is entered', function() {
         input('limit').enter(-3);
         expect(binding('myNumbers | limitTo:limit')).toEqual('[7,8,9]');
       });

     it('should not exceed the maximum size of input array', function() {
         input('limit').enter(100);
         expect(binding('myNumbers | limitTo:limit')).toEqual('[1,2,3,4,5,6,7,8,9]');
       });
     </doc:scenario>
     </doc:example>
     */
 ...
 * }
     ...
     *
     * While a pural category may match many myNumbers (for example, in en-US locale, "other" can match
 ...
 *                      'other': '{} people are viewing.'}">
     ...
     * other myNumbers, for example 12, so that instead of showing "12 people are viewing", you can
 ...
 *                      'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
     ...
     * myNumbers from 0 up to and including the offset. If you use an offset of 3, for example,
