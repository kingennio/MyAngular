 ...
 *     });
     ...
     * @example
     ...
     <doc:scenario>
     it('should format numberOfInstances', function() {
     ...
     * @example
     ...
     <script>
     function Ctrl($scope) {
           $scope.numberOfInstances = [1,2,3,4,5,6,7,8,9];
           $scope.limit = 3;
         }
     </script>
     <div ng-controller="Ctrl">
     Limit {{numberOfInstances}} to: <input type="integer" ng-model="limit">
     <p>Output: {{ numberOfInstances | limitTo:limit }}</p>
     </div>
     </doc:source>
     <doc:scenario>
     it('should limit the numer array to first three items', function() {
         expect(element('.doc-example-live input[ng-model=limit]').val()).toBe('3');
         expect(binding('numberOfInstances | limitTo:limit')).toEqual('[1,2,3]');
       });

     it('should update the output when -3 is entered', function() {
         input('limit').enter(-3);
         expect(binding('numberOfInstances | limitTo:limit')).toEqual('[7,8,9]');
       });

     it('should not exceed the maximum size of input array', function() {
         input('limit').enter(100);
         expect(binding('numberOfInstances | limitTo:limit')).toEqual('[1,2,3,4,5,6,7,8,9]');
       });
     </doc:scenario>
     </doc:example>
     */
 ...
 * }
     ...
     *
     * While a pural category may match many numberOfInstances (for example, in en-US locale, "other" can match
 ...
 *                      'other': '{} people are viewing.'}">
     ...
     * other numberOfInstances, for example 12, so that instead of showing "12 people are viewing", you can
 ...
 *                      'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
     ...
     * numberOfInstances from 0 up to and including the offset. If you use an offset of 3, for example,
